"""Implementation of the diverse beam search strategy """
...
class DiverseDecoder(Decoder):
    ...
    def __init__(self, decoder_args):
        ...
        """
        super(DiverseDecoder, self).__init__(decoder_args)
    ...
    def decode(self, src_sentence):
        """Decodes a single source sentence using diverse beam search. """
        self.count = 0
        self.time = 0
